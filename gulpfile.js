...
const htmlInclude = () => {
    return src([`${srcFolder}/*.html`, `${srcFolder}/catalog/*.html`, `${srcFolder}/products/*.html`])
        .pipe(fileInclude({
            prefix: '@',
            basepath: '@file'
        }))
...
const watchFiles = () => {
    ...
    watch([`${paths.srcPartialsFolder}/*.html`, `${paths.srcPartialsFolder}/catalog/*.html`, `${paths.srcPartialsFolder}/products/*.html`], htmlInclude);
    watch([`${srcFolder}/*.html`, `${srcFolder}/catalog/*.html`, `${srcFolder}/products/*.html`], htmlInclude);
